...
/**
 * Get the old version of the scoreboard for a day. This seems to require header 'Referer: http://stats.nba.com/scores/'
 ...
 */
class ScoreboardMiniRequest extends AbstractStatsStatsRequest
{
    const ENDPOINT = '/stats/scoreboard';
