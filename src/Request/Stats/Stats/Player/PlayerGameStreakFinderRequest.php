 ...
 * This corresponds to Player Streaks searching on the stats.nba.com website.
 ...
 */
class PlayerGameStreakFinderRequest extends AbstractStatsStatsRequest
{
    const ENDPOINT = '/stats/playergamestreakfinder';
